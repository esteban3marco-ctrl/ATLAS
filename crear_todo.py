...
<configuration>
    ...
    with open(f"{carpeta}/simulation.sumocfg", "w") as f:
        f.write(config)
...
<routes>
    ...
    with open(f"{carpeta}/nodes.nod.xml", "w") as f: f.write(nodos)
    with open(f"{carpeta}/edges.edg.xml", "w") as f: f.write(edges)
    with open(f"{carpeta}/traffic.rou.xml", "w") as f: f.write(rutas)
